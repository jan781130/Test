	...
	require(['init-func'], function() {
				...
				require.config({
					paths : {
						...
						bootstrapSwitchCss :  window.glconfig.contentPath + '/assets/plugins/bootstrap-switch/dist/css/bootstrap3/bootstrap-switch.min',
						...
						d3: window.glconfig.contentPath + "/webjars/d3js/4.2.1/d3.min",
			      leafletCss: window.glconfig.contentPath + "/assets/plugins/leaflet/leaflet",
			      leaflet: window.glconfig.contentPath + "/assets/plugins/leaflet/leaflet",
			      mCustomScrollbarCss: window.glconfig.contentPath + '/assets/plugins/custom-scrollbar/jquery.mCustomScrollbar.min',
			      mCustomScrollbar: window.glconfig.contentPath + '/assets/plugins/custom-scrollbar/jquery.mCustomScrollbar',
			      app: window.glconfig.contentPath + '/assets/js/app'
					},
					shim : {
						"angular": {
							deps: ["jquery"],
