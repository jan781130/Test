(function() {
   ...
   */
  window.glfunc.buildNgController("smartTableEx", ['smart-table'], ['$scope','Resource','$location','$anchorScroll','$filter',function(scope, resource, $location, $anchorScroll, $filter) {
