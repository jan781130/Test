...
/**
 * FsmHisNoticeSms generated by hbm2java
 */
@Entity
@Table(name = "FSM_HIS_NOTICE_SMS", catalog = "UMDP")
public class FsmHisNoticeSms implements java.io.Serializable {
  ...
  public FsmHisNoticeSms() {}


  public FsmHisNoticeSms(String id) {
    this.id = id;
  }

  public FsmHisNoticeSms(String id, String noticeEventCd, String subject, String content,
