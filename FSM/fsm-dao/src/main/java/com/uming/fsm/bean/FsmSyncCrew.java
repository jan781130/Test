...
/**
 * FsmSyncCrew generated by hbm2java
 */
@Entity
@Table(name = "FSM_SYNC_CREW", catalog = "UMDP")
public class FsmSyncCrew implements java.io.Serializable {


  private FsmSyncCrewId id;
  ...
  public FsmSyncCrew(FsmSyncCrewId id) {
    this.id = id;
  }

  public FsmSyncCrew(FsmSyncCrewId id, String headShot, String chineseName, String englishNameFirst,
      String englishNameLast, String nationalityCh, String nationalityEn, Date shippedDate,
      String shippedPlaceCh, String shippedPlaceEn, Date displacementDate, String agentCh,
      String agentEn, String rankCh, String rankEn, String rankSeq, Date dob, String seamanBookNo,
      Date seamanBookExpDate, String sfPassportNo, Date sfPassportExpDate, String passportNo,
      Date passportExpDate, String australiaMcvNo, Date australiaMcvExpDate, Date contractExpDate,
      Date planDate, String createUser, Date createDate, String updateUser, Date updateDate) {
    this.id = id;
  ...
  @AttributeOverrides({
      ...
      @AttributeOverride(name = "employeeNo",
          column = @Column(name = "EMPLOYEE_NO", nullable = false, length = 5))})
  public FsmSyncCrewId getId() {
    return this.id;
  }

  public void setId(FsmSyncCrewId id) {
    this.id = id;
  }
