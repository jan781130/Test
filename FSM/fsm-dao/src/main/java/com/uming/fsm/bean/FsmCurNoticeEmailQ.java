...
/**
 * FsmCurNoticeEmailQ generated by hbm2java
 */
@Entity
@Table(name = "FSM_CUR_NOTICE_EMAIL_Q", catalog = "UMDP")
public class FsmCurNoticeEmailQ implements java.io.Serializable {
  ...
  public FsmCurNoticeEmailQ() {}


  public FsmCurNoticeEmailQ(String id) {
    this.id = id;
  }

  public FsmCurNoticeEmailQ(String id, String noticeEventCd, String subject, String content,
