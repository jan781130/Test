...
/**
 * UmdpSyncDept generated by hbm2java
 */
@Entity
@Table(name = "UMDP_SYNC_DEPT", catalog = "UMDP")
public class UmdpSyncDept implements java.io.Serializable {


  private UmdpSyncDeptId id;
  ...
  public UmdpSyncDept(UmdpSyncDeptId id) {
    this.id = id;
  }

  public UmdpSyncDept(UmdpSyncDeptId id, String deptChiName, String deptEngName, String deptSName,
  ...
  @AttributeOverrides({
      ...
      @AttributeOverride(name = "id",
          column = @Column(name = "ID", nullable = false, length = 100))})
  public UmdpSyncDeptId getId() {
    return this.id;
  }

  public void setId(UmdpSyncDeptId id) {
    this.id = id;
  }
