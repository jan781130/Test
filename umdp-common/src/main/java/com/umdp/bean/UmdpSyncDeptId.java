...
/**
 * UmdpSyncDeptId generated by hbm2java
 */
@Embeddable
public class UmdpSyncDeptId implements java.io.Serializable {


  private Date syncDate;
  private String id;

  public UmdpSyncDeptId() {}

  public UmdpSyncDeptId(Date syncDate, String id) {
  ...
  public boolean equals(Object other) {
    ...
    if ((other == null))
      return false;
    if (!(other instanceof UmdpSyncDeptId))
      return false;
    UmdpSyncDeptId castOther = (UmdpSyncDeptId) other;
