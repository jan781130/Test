...
/**
 * UmdpCurNoticeSmsQ generated by hbm2java
 */
@Entity
@Table(name = "UMDP_CUR_NOTICE_SMS_Q", catalog = "UMDP")
public class UmdpCurNoticeSmsQ implements java.io.Serializable {
  ...
  public UmdpCurNoticeSmsQ() {}


  public UmdpCurNoticeSmsQ(long id) {
    this.id = id;
  }

  public UmdpCurNoticeSmsQ(long id, String noticeEventCd, String subject, String content,
